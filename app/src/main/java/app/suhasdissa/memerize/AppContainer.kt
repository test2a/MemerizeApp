...
import app.test2a.memerize.backend.repositories.LemmyCommunityRepositoryImpl
import app.test2a.memerize.backend.repositories.LemmyMemeRepository
import app.test2a.memerize.backend.repositories.LemmyMemeRepositoryImpl
import app.test2a.memerize.backend.repositories.RedditCommunityRepository
import app.test2a.memerize.backend.repositories.RedditCommunityRepositoryImpl
import app.test2a.memerize.backend.repositories.RedditMemeRepository
import app.test2a.memerize.backend.repositories.RedditMemeRepositoryImpl
